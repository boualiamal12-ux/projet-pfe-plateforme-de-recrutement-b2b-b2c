...
//
//    @PatchMapping("/{id}/geocode")
//    public ResponseEntity<?> saveGeocode(@PathVariable Long id, @RequestBody Map<String, String> body) {
//        OffreEmploi offre = OffreEmploiRepository.findById(id)
//                .orElseThrow(() -> new RuntimeException("Offre introuvable"));
//        offre.setAdresseGeocodee(body.get("adresseGeocodee"));
//        OffreEmploiRepository.save(offre);
//        return ResponseEntity.ok(Map.of("success", true, "adresseGeocodee", offre.getAdresseGeocodee()));
//    }
}